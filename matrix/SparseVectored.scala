...
class SparseVectored(
   ...
   */
  final def multiplySparse(other: SparseVectored): Coordinated = {
    ...
    new Coordinated(result, nRows, other.nCols)
  }
  ...
  */
  def toDenseVecMatrix(): DenseVectored = {
    ...
    new DenseVectored(result, nRows, nCols)
  }
